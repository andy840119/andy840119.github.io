...
接下來問說如何把資料從Database撈出來丟到前端的流程

還有前端如果修改後，如何存回Database等等
...
然後未來目標(不才回答`Dep-ops工程師`，然後被回說Sql語法也是Dep-ops需要面對到的問題wwww)

在公司最不喜歡做什麼(爛事，但那時候腦子不好使，沒解釋成做重複，沒意義，亂做寫爛Code把程式搞糟的事情)
